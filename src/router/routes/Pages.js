...
const PagesRoutes = [
  ...
  {
    path: '/user',
    component: lazy(() => import('../../views/apps/userPanel/User')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
  ...
  {
    path: '/rentDetails',
    component: lazy(() => import('../../views/apps/userPanel/Pages/RentDetails')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
  ...
  {
    path: '/rentInnerDetails',
    component: lazy(() => import('../../views/apps/userPanel/Pages/RentInnerDetails')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
