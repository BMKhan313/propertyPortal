...
const AppRoutes = [
  ...
  {
    path: '/apps/admin/projects/addnewproject',
    exact: true,

    className: 'new-project',
    component: lazy(() =>
      import('../../views/apps/adminPortal/projects/addNewProject')
    )
  },
  {
    path: '/apps/admin/projects/viewProjects',
    exact: true,

    className: 'view-project',
    component: lazy(() =>
      import('../../views/apps/adminPortal/projects/ViewProjects/list')
    )
  },
  {
    path: '/apps/admin/developers/viewDevelopers',
    exact: true,

    className: 'new-developer',
    component: lazy(() =>
      import('../../views/apps/adminPortal/Developers/list')
    )
  }
]
