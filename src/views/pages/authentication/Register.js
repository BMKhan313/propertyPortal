      ...
      <Row className='auth-inner m-0'>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <CardText className='mb-2'>Make your shops management easy!</CardText>
            ...
            <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input autoFocus placeholder='Your Username' invalid={errors.username && true} {...field} />
                  )}
                />
              ...
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input type='email' placeholder='example@email.com' invalid={errors.email && true} {...field} />
                  )}
                />
