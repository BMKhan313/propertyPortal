...
const noParkings = props => {
  ...
  return (
    <Row className='justify-content-between align-items-center'>
      {store.projectData.floors[props.i].noParkings > 0 && (
        <Accordion className='accordion-border' open={open} toggle={toggleopen}>
          <Card>
            <CardHeader>
              <h4 className='card-title'>
                Total parkings:{' '}
                {store.projectData.floors[props.i].noParkings}:{' '}
              </h4>
            </CardHeader>
            <CardBody>
              <Repeater count={store.projectData.floors[props.i].noParkings}>
                {ii => (
                  <Form key={ii}>
                    <AccordionItem>
                        ...
                        <Row className='justify-content-between align-items-center'>
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <Input
                              ...
                              placeholder='32'
                              value={
                                store.projectData.floors[props.i].parkings[
                                  ii
                                ].length
                              }
                              onChange={e => {
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            {
                              (store.projectData.floors[props.i].parkings[ii].width === '' || store.projectData.floors[props.i].parkings[ii].width === undefined)
                              &&
                              (store.projectData.floors[props.i].parkings[ii].length === '' || store.projectData.floors[props.i].parkings[ii].length === undefined)
                              ? 
                              <InputGroup>
                              ...
                              <Input
                                ...
                                value={store.projectData.floors[props.i].parkings[ii].area}
                                placeholder='0'
                            ...
                            (
                            <div>
                              {store.projectData.floors[props.i].parkings[ii].width * store.projectData.floors[props.i].parkings[ii].length}
                            </div>
                            )
                            }
                          ...
                          <Label >
                            ...
                            <InputGroup>
                              ...
                              <Input
                                ...
                                value={
                                    store.projectData.floors[props.i].parkings[ii].price
                                }
                                placeholder='0'
