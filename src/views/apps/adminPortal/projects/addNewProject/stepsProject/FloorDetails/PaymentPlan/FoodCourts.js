      ...
      {store.projectData.floors[props.i].noFoodCourts > 0 && (
          ...
          <Card>
            ...
            <Row className='mt-1'>
                  ...
                  {ii => ( 
                    <>
                  <Row>
                    <Col md={1} className="payment__header">Food Court #</Col>
       ...
       {/* years */}
                ...
                {/* yrs end */}
                  ...
                  <Col md={3} className="payment__header">{store.projectData.floors[props.i].foodCourts[ii].plan === 'Quarter' ?  'installment Per Quarter' : 'installment Per Month'}</Col>
                  <Col md={3} className="payment__header">Arrears { store.projectData.floors[props.i].foodCourts[ii].planForDues ==='quarterly' ? 'Per Quarter' : store.projectData.floors[props.i].foodCourts[ii].planForDues === 'bi-annual'  ? 'Per Bi-Annum' : store.projectData.floors[props.i].foodCourts[ii].planForDues === 'annually' ? 'Per Annum' : ''   }</Col>
