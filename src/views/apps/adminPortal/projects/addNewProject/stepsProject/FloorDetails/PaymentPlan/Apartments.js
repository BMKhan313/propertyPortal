                    ...
                    <Row className='mt-2'>
                      ...
                      <Col md={2}>
                        <div className='payment__text'>
                            {/* total cost */} 
                            {/* {
                              ((store.projectData.floors[props.i].priceapartments) 
                                * ((store.projectData.floors[props.i].apartments[ii].length) * 
                                 (store.projectData.floors[props.i].apartments[ii].width)))
                      ...
                      <Col md={2}>
                        ...
                        //      * (store.projectData.floors[props.i].apartments[ii].width))
                        //     *
                        //      (store.projectData.floors[props.i].apartments[ii].downPaymentPercentage)
                        //      )) / 100)
                        }
                        onChange={(e) => {                        
                          dispatch(
                              ...
                              onChange={e => {
                                ...
                                dispatch(
                                  updateFloorInnerProperties([
                                    // ((store.projectData.floors[props.i].apartments[ii].totalCost)
                                    // - ((store.projectData.floors[props.i].apartments[ii].downPaymentPercentage) * 
                                    // (store.projectData.floors[props.i].apartments[ii].totalCost) / 100)) / (e.target.value),
                                    (((12) / (store.projectData.floors[props.i].apartments[ii].quarterDuration)) * (store.projectData.floors[props.i].apartments[ii].paymentYears)),
                                    'floors',
                                    props.i,
                                    'apartments',
                                    ii,
