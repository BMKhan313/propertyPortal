                  ...
                  {ii => ( 
                    <Row className='mt-2'>
                      ...
                      <Col md={2}>
                        <div className='payment__text' >
                            {/* Remainings */}
                            {/* {store.projectData.floors[props.i].shops[ii].totalCost - store.projectData.floors[props.i].shops[ii].downPaymentRs } */}
                        
                        {/* { (store.projectData.floors[props.i].priceShops * (store.projectData.floors[props.i].shops[ii].length * store.projectData.floors[props.i].shops[ii].width))
                         - (((store.projectData.floors[props.i].priceShops) * 
                             (((store.projectData.floors[props.i].shops[ii].length) 
                             * (store.projectData.floors[props.i].shops[ii].width))
                            *
                              ...
                              onChange={e => {
                                ...
                                dispatch(
                                  updateFloorInnerProperties([
                                    // ((store.projectData.floors[props.i].shops[ii].totalCost)
                                    // - ((store.projectData.floors[props.i].shops[ii].downPaymentPercentage) * 
                                    // (store.projectData.floors[props.i].shops[ii].totalCost) / 100)) / (e.target.value),
                                    (((12) / (store.projectData.floors[props.i].shops[ii].quarterDuration)) * (store.projectData.floors[props.i].shops[ii].paymentYears)),
                                    'floors',
                                    props.i,
                                    'shops',
                                    ii,
