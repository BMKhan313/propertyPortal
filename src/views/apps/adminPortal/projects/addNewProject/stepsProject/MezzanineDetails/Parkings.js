...
const noParkings = props => {
  ...
  const CalculateQM_MonthlyPer = (e, i, ii) => {
    ...
    dispatch(
      updateFloorInnerProperties([
        100 -
          store.projectData.mezzanine[props.i].parkings[ii]
                        ...
                        <Row className='justify-content-between align-items-center'>
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <Input
                              ...
                              id={`Parking-width-${ii}`}
                              placeholder='1'
                              value={store.projectData.mezzanine[props.i].parkings[ii].width}
                              onChange={e => {
                                dispatch(
                                  updateFloorInnerProperties([
                                    e.target.value,
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            {
                              (store.projectData.mezzanine[props.i].parkings[ii].width === '' || store.projectData.mezzanine[props.i].parkings[ii].width === undefined)
                              &&
                              (store.projectData.mezzanine[props.i].parkings[ii].length === '' || store.projectData.mezzanine[props.i].parkings[ii].length === undefined)
                              ? 
                              <InputGroup>
                              ...
                              <Input
                                ...
                                value={store.projectData.mezzanine[props.i].parkings[ii].area}
                                placeholder='0'
                            ...
                            (
                            <div>
                              {store.projectData.mezzanine[props.i].parkings[ii].width * store.projectData.mezzanine[props.i].parkings[ii].length}
                            </div>
                            )
                            }
