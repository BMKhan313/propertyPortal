...
const noParkings = props => {
  ...
  const CalculateQM_MonthlyPer = (e, i, ii) => {
    ...
    dispatch(
      updateFloorInnerProperties([
        100 -
          store.projectData.lowerGrounds[props.i].parkings[ii]
  ...
  return (
    <Row className='justify-content-between align-items-center'>
      {store.projectData.lowerGrounds[props.i].noParkings > 0 && (
        <Accordion className='accordion-border' open={open} toggle={toggleopen}>
          <Card>
            <CardHeader>
              <h4 className='card-title'>
                Total parkings:{' '}
                {store.projectData.lowerGrounds[props.i].noParkings}:{' '}
              </h4>
            </CardHeader>
            <CardBody>
              <Repeater count={store.projectData.lowerGrounds[props.i].noParkings}>
                {ii => (
                  <Form key={ii}>
                    <AccordionItem>
                      ...
                      <AccordionBody accordionId={`${ii}`}>
                        <Row className='justify-content-between align-items-center'>
                          {/* <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <InputGroup className='mt-2'>
                              ...
                              <Input
                                ...
                                id={`Parking-Label-${ii}`}
                                placeholder='Parking #'
                                value={store.projectData.lowerGrounds[
                                  props.i
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            {
                              (store.projectData.lowerGrounds[props.i].parkings[ii].width === '' || store.projectData.lowerGrounds[props.i].parkings[ii].width === undefined)
                              &&
                              (store.projectData.lowerGrounds[props.i].parkings[ii].length === '' || store.projectData.lowerGrounds[props.i].parkings[ii].length === undefined)
                              ? 
                              <InputGroup>
                              ...
                              <Input
                                ...
                                value={store.projectData.lowerGrounds[props.i].parkings[ii].area}
                                placeholder='0'
                            ...
                            (
                            <div>
                              {store.projectData.lowerGrounds[props.i].parkings[ii].width * store.projectData.lowerGrounds[props.i].parkings[ii].length}
                            </div>
                            )
                            }
                          ...
                          <Label >
                            ...
                            <InputGroup>
                              ...
                              <Input
                                ...
                                value={
                                    store.projectData.lowerGrounds[props.i].parkings[ii].price
                                }
                                placeholder='0'
                                id={`Parking-PricePerFoot-${ii}`}
                              />
                            </InputGroup>
                          </Col>
