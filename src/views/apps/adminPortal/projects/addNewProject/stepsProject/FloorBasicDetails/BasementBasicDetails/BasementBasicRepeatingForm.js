                    ...
                    />
                      ...
                      id={`Shop-Plan-${j}`}
                                ...
                                dispatch(
                                  updateFloorProperties([
                                    (store.projectData.basements[j].basicPlan === 'Quarter' ? 
                                    (store.projectData.basements[j].cashBasicPayment === 0 ? (0) : ( (4 * store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment  * 12)) ) 
                                          : 
                                    (store.projectData.basements[j].cashBasicPayment === 0 ? 
                                      (0) : ((12 * store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment * 12) )) ),
                                    'basements',
                                    j,
                                    'arrearsBasicIntallmentOnEachPeriod'
                                  ])
                                ...
                                dispatch(
                                  updateFloorProperties([
                                    ...
                                    (store.projectData.basements[j].cashBasicPayment === 0 ? (0) : (((12 * store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment * 12) ) / 4  )) 
                                       :
                                    (store.projectData.basements[j].cashBasicPayment === 0 ? (0) : (((4 * store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment * 12) ) / 4 ))
                                    ),
                                    'basements',
                                    j,
                                    'arrearsBasicIntallmentOnEachPeriod',
...
//                                 dispatch(
//                                   updateFloorProperties([
//                                     (store.projectData.basements[j].cashBasicPayment === 0 ? (0) : ((store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment * 12) )),
//                                     'basements',
//                                     j,
//                                     'arrearsBasicIntallmentOnEachPeriod'
//                                   ])
...
//                                 dispatch(
//                                   updateFloorProperties([
//                                     (store.projectData.basements[j].cashBasicPayment === 0 ? (0) : ((store.projectData.basements[j].installmentPerDuration) - (store.projectData.basements[j].cashBasicPayment * 3))),
//                                     'basements',
//                                     j,
//                                     'arrearsBasicIntallmentOnEachPeriod',
//                                   ])
