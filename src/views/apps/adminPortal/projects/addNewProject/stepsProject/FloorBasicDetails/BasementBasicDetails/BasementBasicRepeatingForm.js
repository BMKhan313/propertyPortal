    ...
    <div>
       <Repeater
        ...
        >
                    ...
                    <div  className='payment__text'>{store.projectData.basements[j].minPrice} </div>
                    
                      </Col>
                      <Col md={1} style={{display: 'flex', justifyContent: 'flex-start'}} >
                      <div className='payment__text'>{store.projectData.basements[j].maxPrice} </div>
                      </Col>
          ...
          <Card>
            ...
            <Row className='mt-1'>
                  ...
                  {/* <Repeater count={store.projectData.basements[j].basementPaymentPlan}> */}
                  {/* {ii => (  */}
                    <Row className='mt-2'>
                      <Col md={1} ><div className='payment__text'>Basement {j + 1}  </div></Col>
                      <Col md={2} >
                        <div className='payment__text'>
                            {/* total cost */} 
                            {/* {
                        ...
                        onChange={(e) => {                        
                          ...
                          dispatch(
                            updateFloorProperties([
                              ((store.projectData.basements[j].maxPrice)
                            - ((e.target.value) * 
                            (store.projectData.basements[j].maxPrice) / 100)),
                              'basements',
                              j,
                              'remainingBasicRs'
                            ])
