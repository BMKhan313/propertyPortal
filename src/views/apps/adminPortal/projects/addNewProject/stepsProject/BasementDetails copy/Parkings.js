...
const noParkings = props => {
  ...
  return (
    <Row className='justify-content-between align-items-center'>
      {store.projectData.basements[props.i].noParkings > 0 && (
        <Accordion className='accordion-border' open={open} toggle={toggleopen}>
          <Card>
            <CardHeader>
              <h4 className='card-title'>
                Total parkings:{' '}
                {store.projectData.basements[props.i].noParkings}:{' '}
              </h4>
            </CardHeader>
            <CardBody>
              <Repeater count={store.projectData.basements[props.i].noParkings}>
                {ii => (
                  <Form key={ii}>
                    <AccordionItem>
                        ...
                        <Row className='justify-content-between align-items-center'>
                          {/* <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <InputGroup className='mt-2'>
                              ...
                              <Input
                                ...
                                id={`Parking-Label-${ii}`}
                                placeholder='Parking #'
                                value={store.projectData.basements[
                                  props.i
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <Input
                              ...
                              placeholder='32'
                              value={
                                store.projectData.basements[props.i].parkings[
                                  ii
                                ].length
                              }
                              onChange={e => {
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            {
                            (store.projectData.basements[props.i].parkings[ii].width === '' || store.projectData.basements[props.i].parkings[ii].width === undefined)
                            &&
                            (store.projectData.basements[props.i].parkings[ii].length === '' || store.projectData.basements[props.i].parkings[ii].length === undefined)
                            ?
                            <InputGroup>
                              ...
                              <Input
                                ...
                                value={store.projectData.basements[props.i].parkings[ii].area}
                                placeholder='0'
                            ...
                            ( 
                            <div>
                              { store.projectData.basements[props.i].parkings[ii].width * store.projectData.basements[props.i].parkings[ii].length }
                            </div>
                            )
                            }
                          ...
                          <Label >
                            ...
                            <InputGroup>
                              ...
                              <Input
                                ...
                                value={
                                    store.projectData.basements[props.i].parkings[ii].price
                                }
                                placeholder='0'
                            ...
                            <CardHeader className='align-items-center'>
                              <CardTitle>
                                ...
                                {parseFloat(
                                  ...
                                  parseFloat(
                                    store.projectData.basements[props.i]
