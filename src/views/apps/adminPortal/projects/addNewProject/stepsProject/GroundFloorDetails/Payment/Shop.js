                    ...
                    <Row className='mt-2'>
                      ...
                      <Col md={2}>
                        <div className='payment__text'>
                            {/* total cost */} 
                            {/* {
                              ((store.projectData.groundFloors[props.i].priceShops) 
                                * ((store.projectData.groundFloors[props.i].shops[ii].length) * 
                                 (store.projectData.groundFloors[props.i].shops[ii].width)))
                      ...
                      <Col md={2}>
                        ...
                        value={
                          ...
                          //     (store.projectData.groundFloors[props.i].shops[ii].width))
                          //    *
                          //     (store.projectData.groundFloors[props.i].shops[ii].downPaymentPercentage)
                          //     )) / 100)
                        }
                        // onChange={(e) => {                        
                        //   dispatch(
                      ...
                      <Col md={2}>
                        <div className='payment__text' >
                            {/* Remainings */}
                            {/* {store.projectData.groundFloors[props.i].shops[ii].totalCost - store.projectData.groundFloors[props.i].shops[ii].downPaymentRs } */}
                              ...
                              onChange={e => {
                                ...
                                dispatch(
                                  updateFloorInnerProperties([
                                    // ((store.projectData.groundFloors[props.i].shops[ii].totalCost)
                                    // - ((store.projectData.groundFloors[props.i].shops[ii].downPaymentPercentage) * 
                                    // (store.projectData.groundFloors[props.i].shops[ii].totalCost) / 100)) / (e.target.value),
                                    (((12) / (store.projectData.groundFloors[props.i].shops[ii].quarterDuration)) * (store.projectData.groundFloors[props.i].shops[ii].paymentYears)),
                                    'groundFloors',
                                    props.i,
                                    'shops',
                                    ii,
