      ...
      {store.projectData.groundFloors[props.i].noApartments > 0 && (
          ...
          <Card>
            ...
            <Row className='mt-1'>
                  ...
                  <Row>
                    ...
                    <Row className='mt-2'>
                      <Col md={1}><div className='payment__text' style={{fontFamily: 'cursive'}}>mezzanine-{ii + 1}  </div></Col>
                      <Col md={2}>
       ...
       {/* years */}
                ...
                {/* yrs end */}
                  ...
                  <Col md={3} className="payment__header">{store.projectData.groundFloors[props.i].apartments[ii].plan === 'Quarter' ?  'installment Per Quarter' : 'installment Per Month'}</Col>
                  <Col md={3} className="payment__header">Arrears { store.projectData.groundFloors[props.i].apartments[ii].planForDues ==='quarterly' ? 'Per Quarter' : store.projectData.groundFloors[props.i].apartments[ii].planForDues === 'bi-annual'  ? 'Per Bi-Annum' : store.projectData.groundFloors[props.i].apartments[ii].planForDues === 'annually' ? 'Per Annum' : ''   }</Col>
