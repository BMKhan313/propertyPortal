...
const noParkings = props => {
  ...
  const CalculateQM_MonthlyPer = (e, i, ii) => {
    ...
    dispatch(
      updateFloorInnerProperties([
        100 -
          store.projectData.groundFloors[props.i].parkings[ii]
  ...
  return (
    <Row className='justify-content-between align-items-center'>
      {store.projectData.groundFloors[props.i].noParkings > 0 && (
        <Accordion className='accordion-border' open={open} toggle={toggleopen}>
          <Card>
            <CardHeader>
              <h4 className='card-title'>
                Total parkings:{' '}
                {store.projectData.groundFloors[props.i].noParkings}:{' '}
              </h4>
            </CardHeader>
            <CardBody>
              <Repeater count={store.projectData.groundFloors[props.i].noParkings}>
                {ii => (
                  <Form key={ii}>
                    <AccordionItem>
                        ...
                        <Row className='justify-content-between align-items-center'>
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            <Input
                              ...
                              placeholder='32'
                              value={
                                store.projectData.groundFloors[props.i].parkings[
                                  ii
                                ].length
                              }
                              onChange={e => {
                          ...
                          <Col md={2} className='mb-md-0 mb-1'>
                            ...
                            {
                              (store.projectData.groundFloors[props.i].parkings[ii].width === '' || store.projectData.groundFloors[props.i].parkings[ii].width === undefined)
                              &&
                              (store.projectData.groundFloors[props.i].parkings[ii].length === '' || store.projectData.groundFloors[props.i].parkings[ii].length === undefined)
                              ? 
                              <InputGroup>
                              ...
                              <Input
                                ...
                                value={store.projectData.groundFloors[props.i].parkings[ii].area}
                                placeholder='0'
                            ...
                            (
                            <div>
                              {store.projectData.groundFloors[props.i].parkings[ii].width * store.projectData.groundFloors[props.i].parkings[ii].length}
                            </div>
                            )
                            }
                            ...
                            <CardHeader className='align-items-center'>
                              <CardTitle>
                                ...
                                {parseFloat(
                                  ...
                                  parseFloat(
                                    store.projectData.groundFloors[props.i]
